...
namespace SpecFlow_Calculator_WebApp.Steps
{
    ...
    public sealed class NumberCalculatorSteps
    {
        ...
        public static void OpenCalculatorApp()
        {
            ...
            var linkNumberCalc = driver.FindElementByXPath("//a[@href='#'][contains(.,'Number Calculator')]");
            ...
            dropDownOperation = new SelectElement(driver.FindElementByCssSelector("select#operation"));
            buttonCalc = driver.FindElementByCssSelector("#screenNumberCalc input[value='Calculate']");
            buttonReset = driver.FindElementByCssSelector("#screenNumberCalc input[value='Reset']");
        ...
        public void WhenTheTwoNumbersAreAdded(string operation)
        {
            ...
            else if (operation == "divided")
            {
                ...
                throw new InvalidOperationException($"Operation {operation} is not supported by Number Calculator");
